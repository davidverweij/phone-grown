...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (typeof(gSheetLink) != "undefined" && gSheetLink != "") {
    document.getElementById("scriptUrl").value = gSheetLink;
    submitID(gSheetLink);
  }
...
function showConnectUI(error = 0, show=true, suberror=''){
  let messages = [
    "Vul hier je <b>PhoneGrown ID</b> in",
    "Error <b>404</b><br/><br/>\
        Er was een probleem met het ID of de web app. Controleer het ID en probeer nogmaals.\
        <br /><br/>\
        <span class='small'>Als deze error blijft voorkomen, bezoek de website via de link: <br/>\
        <a href='https://www.phonegrown.site/nl/#error404' target='_blank'>www.phonegrown.site/nl/#error404</a></span>",
    "Error <b>500</b><br/><br/>\
        Er was een probleem met de Google Sheet.\
        <br /><br/>\
        <span class='small'>Bezoek de website via de link <br/>\
        <a href='https://www.phonegrown.site/nl/#error500' target='_blank'>www.phonegrown.site/nl/#error500</a></span>",
    "Error <b>400</b><br/><br/>\
        Er was een onbekend probleem. Herlaad de website en probeer opniew.\
        <br /><br/>\
        <span class='small'>Als deze error blijft voorkomen, bezoek de website via de link: <br/>\
        <a href='https://www.phonegrown.site/nl/#error400' target='_blank'>www.phonegrown.site/nl/#error400</a></span>",
    "Error <b>503</b><br/><br/>\
        Er was een probleem met de database. Probeer nogmaals verbinding te maken door de ID in te vullen.\
        <br /><br/>\
        <span class='small'>Als deze error blijft voorkomen, bezoek de website via de link: <br/>\
        <a href='https://www.phonegrown.site/nl/#error503' target='_blank'>www.phonegrown.site/nl/#error503</a></span>",
  ]
    ...
    xhr.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        ...
        if (result.result == "success") {
          gSheetLink = url;
          databasePing = result.databasePing;
...
function startDatabaseListener() {
  db_unsubscribe = db.collection("anonymous").doc(databasePing)
...
function getDataFromSheet() {
  ...
  xhr.open("GET", "https://tinyurl.com/" + gSheetLink + "?origin=phone&data=update&lastInstruction=" + lastSeenInstruction + "&now=" + (new Date).toISOString(), true); // true for asynchronous
  xhr.send();
}
...
function updateAmbientDisplay(newInstructions = '[]') {
  ...
  if (sleeping > 60) {
    ...
    html = "<div class='sleepmode'>slaap modus...</div>";
