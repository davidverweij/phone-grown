...
Aside from being curious about what you have created, we are also running a research study about this tutorial. In this study, we ask families to create a smart display following this tutorial _four times_, once each week. We would then like to hear how they got along, and how they've put their smart display to use! To do so, we will have two virtual interviews of ~1.5 hours - one at the beginning and one at the end - and keep in touch through weekly (and short) video calls. We are looking for families with at least one child (~4-16 years old) living at home. If you don't have an old phone or tablet, we can borrow you one for the duration of this study. To show our thanks, we are giving each participating family a £100,- Amazon Voucher. Interested, or questions? Please contact the researcher at _d.verweij2[@]newcastle.ac.uk_.
