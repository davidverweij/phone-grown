...
1. This will ask you to _Review Permissions_. You might need to log in with your Google Account.
...
1. Click _Update_ and _Copy the long URL_ link shown in the popup, and
...
Also, at any given time, you can visit the Google Sheet and browse through the _**[DATA] History**_ tab. This will show you all past times when one of your IFTTT applets 'triggered'.
